...
void regler()
{
    system("cls");
    huvudord();
    printf("\n\n\nBlack Jack går ut på att man ska få 21 eller så nära 21 som möjligt.\nMan spelar mot banken (datorn).\nSpelet går till så att man fört får 2 kort, summan av dessa kort läggs ihop och du har ett tal. Efter det får du välja genom att antingen ta ett till kort\neller stanna.\n\n");
    system("pause");
}
...
{
    int blackjackvarde = 0; /*alla klädda kort är väda 10 i blackjack*/
...
void blackjack()
{
    ...
    while(spela)
    {
        ...
        if(spela == false)/*avslutar eftersom spelarren gått över 21 i kortvärde*/
        {
            break;
        }
